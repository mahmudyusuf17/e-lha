                            ...
                            <?php 
                                    ...
                                    <div class="col-md-12 text-center mt-5 mb-5">
                                        <div class="container">
                                            <ul class="progressbar">
                                                ...
                                                <li><a href="<?= base_url()?>/surattugas/input_team/<?= $surat->idSurtu?>"><span class="text-hitam">Input Team</span></a></li>
                                                <li>Preview</li>
                                            </ul>
                                        </div>
                                </div>
                                ...
                                <form method="post" id="forminputsurtu" enctype="multipart/form-data" action="<?php echo base_url('surattugas/input')?>">
                                            ...
                                            <div class="mt-5" id="buttonpage1"><hr>
                                                ...
                                                <a href="<?= base_url()?>/surattugas/input_team/<?= $surat->idSurtu?>" class="btn btn-success" type="button">Next</a>
