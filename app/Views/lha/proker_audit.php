							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header overview-wrap">
										<h3><i class="mr-2 fa fa-file-text"></i><strong class="card-title" v-if="headerText">Program Kerja Audit</strong></h3>
                                    </div>
                                <div class="card-body">
                                <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="table-responsive m-b-40 mt-3">
                                    ...
                                    <?php
                                        ...
                                        <td><?php if($data->status_lha==2){
                                        echo('Selesai');
                                        } elseif ($data->status_lha==1) {
                                            echo('Progress');
                                        }
                                        else{
                                        echo('');
