							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header overview-wrap">
										<h3><i class="mr-2 fa fa-copy"></i><strong class="card-title" v-if="headerText">Evaluasi Audit</strong></h3>
                                    </div>
                                <div class="card-body">
                                <div class="row">
                                <div class="col-md-12">
                                <h4>Evaluasi Audit</h4>
                                <div class="table-responsive m-b-40 mt-3">
                                    ...
                                    <?php
                                        ...
                                        <td><?php if($data->status_lhe==2){
                                        echo('Selesai');
                                        } elseif ($data->status_lhe==1) {
                                            echo('Progress');
                                        }
                                        else{
                                        echo('');
                                        ...
                                        ?></td>
                                        <td><?= $data->nomor_lhe ?></td>
                                        <td><?php if($data->status_lhe==1){
